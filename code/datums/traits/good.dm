...
/datum/quirk/critterfriend
	...
	value = 14
	category = "Critter Quirks"
	mechanics = "Specifically radroachs, geckos and young nightstalkers treat you as being a faction friend. Ignoring you outright."
	conflicts = list(
...
/datum/quirk/crittermaster
	...
	desc = "Whenever by psychic means or not, you gained ability to control radroachs, most geckos and giant rats (last ones will be initially hostile and needs to be tamed).\
	...
	value = 34
	category = "Critter Quirks"
	mechanics = "You can tame and order around radroachs, geckos (not all of the full variety pack though) and giant rats. While unable to attack players with them, they're a great distraction for fighting other mobs with."
	conflicts = list(
		/datum/quirk/critterfriend,
	)
